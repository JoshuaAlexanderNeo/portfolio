	...
	return (
		<div className="mb-8 flex justify-between items-center w-full right-timeline">
			...
			<div className="order-1 w-5/12 py-4 ">
				<h3 className="mb-1 font-bold text-gray-800 text-sm sm:text-xl dark:text-gray-200">
					{company}
				</h3>
				<h2 className="mb-1 text-gray-800 text-xs sm:text-base dark:text-gray-200">
					{title}
				</h2>
				<h1 className="font-light text-gray-500 text-xs sm:text-base dark:text-gray-200">
					{date}
				</h1>
			</div>
		</div>
	...
	return (
		<div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
			...
			<div className="order-1 w-5/12 justify-center py-4">
				<h3 className="mb-1 font-bold text-gray-800 flex justify-end text-sm sm:text-xl dark:text-gray-200">
					{company}
				</h3>
				<h2 className="mb-1 text-gray-800 flex justify-end text-xs sm:text-base dark:text-gray-200">
					{title}
				</h2>
				<h1 className="font-light text-gray-500 flex justify-end text-xs sm:text-base dark:text-gray-200">
					{date}
				</h1>
			</div>
		</div>
