...
const Project = ({ tagList, title, description, github, site, image }) => {
  return (
    <div className='container mx-auto w-full h-full'>
      <div className='py-1'>
        <div className='grid grid-cols-1 overflow-hidden bg-white border border-gray-100 rounded-lg group sm:grid-cols-8'>
          <div className='relative'>
            <img className='absolute inset-0 object-cover object-left w-full h-full' src={image} alt='' />
          </div>
          ...
          <div className='p-8 sm:col-span-6'>
            ...
            <div className='mt-4 flex divide-x-2'>
              {github && (
                <Link href={github}>
                  <div
                    className={`flex align-middle px-3 py-1 text-xs font-semibold text-black leading-5 cursor-pointer`}>
                    <svg className='w-4 h-4 mr-1' role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                      <title>GitHub</title>
              ...
              {site && (
                <Link href={site}>
                  <div
                    className={`flex align-middle px-3 py-1 text-xs font-semibold text-black leading-5 divide-x-4 cursor-pointer`}>
                    <svg className='w-4 h-4 mr-1' role='img' viewBox='0 0 48 48' xmlns='http://www.w3.org/2000/svg'>
                      <title>Website</title>
