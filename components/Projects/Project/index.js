        ...
        <a
          ...
          <div className='p-8 sm:col-span-6'>
            ...
            <div className='mt-4 flex divide-x-2'>
              {github && (
                <Link href={github}>
                  <div className={`flex align-middle px-3 py-1 text-xs font-semibold text-black leading-5`}>
              ...
              {site && (
                <Link href={github}>
                  <div className={`flex align-middle px-3 py-1 text-xs font-semibold text-black leading-5 divide-x-4`}>
